...
class SubscriptionPlanPolicy
{
    ...
    {
        return $user->can('force_delete_subscription::plan');
    }
    ...
    {
        return $user->can('force_delete_any_subscription::plan');
    }
    ...
    {
        return $user->can('restore_subscription::plan');
    }
    ...
    {
        return $user->can('restore_any_subscription::plan');
    }
    ...
    {
        return $user->can('replicate_subscription::plan');
    }
    ...
    {
        return $user->can('reorder_subscription::plan');
    }
}
