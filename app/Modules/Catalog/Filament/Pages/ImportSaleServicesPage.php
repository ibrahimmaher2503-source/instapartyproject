...
class ImportSaleServicesPage extends Page implements HasForms
{
    ...
    {
        return __('catalog.nav.import_sale_services');
    }
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('downloadTemplate')
                ...
                ->color('gray')
                ->url(route('admin.catalog.import.template', ['type' => 'sale']))
                ->openUrlInNewTab(),
        ];
    }
