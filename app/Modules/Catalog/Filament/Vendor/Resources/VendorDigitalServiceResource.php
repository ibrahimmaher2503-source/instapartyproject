...
use App\Modules\Catalog\Filament\Vendor\Resources\VendorDigitalServiceResource\Pages\CreateVendorDigitalService;
use App\Modules\Catalog\Filament\Vendor\Resources\VendorDigitalServiceResource\Pages\EditVendorDigitalService;
use App\Modules\Catalog\Filament\Vendor\Resources\VendorDigitalServiceResource\Pages\ListVendorDigitalServices;
...
class VendorDigitalServiceResource extends Resource
{
                    ...
                    Grid::make(2)->schema([
                        Select::make('digitalDetail.delivery_method')
                            ...
                            ->options([
                                ...
                                'in_app' => __('catalog.delivery_methods.in_app'),
                                'url' => __('catalog.delivery_methods.link'),
                            ])
                            ->required(),
    ...
    {
        return [
            'index' => ListVendorDigitalServices::route('/'),
            'create' => CreateVendorDigitalService::route('/create'),
            'edit' => EditVendorDigitalService::route('/{record}/edit'),
        ];
    }
