...
class ApproveServiceChangeRequestRequest extends FormRequest
{
    ...
    {
        return [
            'admin_note' => ['sometimes', 'array'],
            'admin_note.en' => ['required_with:admin_note', 'string', 'max:4000'],
            'admin_note.ar' => ['required_with:admin_note', 'string', 'max:4000'],
