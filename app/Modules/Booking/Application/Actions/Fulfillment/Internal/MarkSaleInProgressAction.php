...
use App\Modules\Booking\Domain\States\SaleItemStatus\OutForDeliveryState;

class MarkSaleInProgressAction extends AbstractMarkFulfillmentAction
{
    ...
    {
        return [OutForDeliveryState::class];
    }
}
