 ...
 */
class StateTransitionFactory extends Factory
{
    ...
    public function adminOverride(string $reason): static
    {
        return $this->state(['trigger_kind' => 'admin_override', 'reason' => $reason]);
    }
}
