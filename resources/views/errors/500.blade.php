...
<head>
    ...
    <title>{{ __('vendor-portal.errors.server_error_title') }} — InstaParty</title>
    <style>
...
<body>
    <div class="container">
        ...
        <h1>{{ __('vendor-portal.errors.server_error_title') }}</h1>
        <p>{{ __('vendor-portal.errors.server_error_message') }}</p>
